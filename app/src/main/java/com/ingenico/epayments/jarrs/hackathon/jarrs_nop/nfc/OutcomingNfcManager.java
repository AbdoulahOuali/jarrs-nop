package com.ingenico.epayments.jarrs.hackathon.jarrs_nop.nfc;
...
public class OutcomingNfcManager implements NfcAdapter.CreateNdefMessageCallback,
    ...
    public NdefMessage createNdefMessage(NfcEvent event) {
        ...
        NdefRecord outRecord = NdefRecord.createMime("application/com.ingenico.epayments.jarrs.hackaton.oqp", outBytes);
